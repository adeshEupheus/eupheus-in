...
export namespace Prisma {
  ...
  */
  ...
  export type SchoolsGetPayload<
    ...
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof Schools ? Schools[P] : never
  } 
    : Schools
  : Schools
  ...
  export interface SchoolsDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    /**
     * Find one Schools that matches the filter or throw
     * `NotFoundError` if no matches were found.
     ...
     * })
    **/
    findUniqueOrThrow<T extends SchoolsFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, SchoolsFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__SchoolsClient<Schools>, Prisma__SchoolsClient<SchoolsGetPayload<T>>>
     ...
     * })
    **/
    findFirstOrThrow<T extends SchoolsFindFirstOrThrowArgs>(
      args?: SelectSubset<T, SchoolsFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__SchoolsClient<Schools>, Prisma__SchoolsClient<SchoolsGetPayload<T>>>
  ...
  /**
   * Schools base type for findUnique actions
   */
  export type SchoolsFindUniqueArgsBase = {
    /**
   ...
   * Schools: findUnique
   */
  export interface SchoolsFindUniqueArgs extends SchoolsFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
  ...
  /**
   * Schools base type for findFirst actions
   */
  export type SchoolsFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Schools
     * 
    **/
   ...
   * Schools: findFirst
   */
  export interface SchoolsFindFirstArgs extends SchoolsFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type SchoolsFindUniqueOrThrowArgs = SchoolsFindUniqueArgsBase
      

  /**
   * Schools: findFirstOrThrow
   */
  export type SchoolsFindFirstOrThrowArgs = SchoolsFindFirstArgsBase
